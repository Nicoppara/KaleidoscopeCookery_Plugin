...
/**
 * 高汤锅汤底表：唯一来源是配置 {@code stock_food_raw.liquid}
 * 每条登记一个可倒入的桶物品 → 锅中液面展示模型映射；stock_flex_foods 的 liquid 条件即引用这些桶 id
 */
public final class SoupBaseRegistry {
    ...
    public static SoupBaseRegistry instance() { return INSTANCE; }
