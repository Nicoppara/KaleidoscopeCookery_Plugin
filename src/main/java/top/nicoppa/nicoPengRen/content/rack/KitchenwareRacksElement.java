...
/**
 * 厨具架渲染元素 用左右两个独立命名的 ItemDisplay 假实体展示厨具，生成并缓存增删改与移位的客户端包
 * 数据来源见 {@link KitchenwareRacksController}，交互入口见 {@link KitchenwareRacksBehavior}
 */
