...
/**
 * 蒸笼渲染元素 用 8 个 ItemDisplay 显示笼内食物
 * 实体身份与收发委托 {@link ItemDisplaySet}，数据来源 {@link SteamerController}，交互入口见 {@link SteamerBehavior}
 */
public final class SteamerElement implements BlockEntityElement {
    ...
    public void update(@NotNull Player player) {
        if (currentVisibleCount > lastVisibleCount) {
            ...
            it.unimi.dsi.fastutil.ints.IntList idsToRemove = MiscUtils.init(new IntArrayList(), a -> {
